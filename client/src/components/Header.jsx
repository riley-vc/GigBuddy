...
export default function Header({ role, userName, userAvatar, escrowTotal }) {
  return (
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-bold text-zinc-50 tracking-tight text-lg">GigBuddy</span>
              ...
              <p className="text-[10px] text-zinc-500 tracking-wide">Musician Marketplace & MoA Escrow</p>
            </div>
          </div>
