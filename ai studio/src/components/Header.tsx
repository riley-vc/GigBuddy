import { Radio, ShieldAlert, Sparkles, User, LogOut, Disc } from 'lucide-react';
...
export default function Header({ role, userName, userAvatar, escrowTotal }: HeaderProps) {
  return (
        ...
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-violet-600 flex items-center justify-center text-zinc-50 shadow-lg shadow-violet-600/20 relative overflow-hidden group">
              ...
              <Disc className="w-5 h-5 relative z-10 animate-[spin_8s_linear_infinite]" />
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-display font-bold text-zinc-50 tracking-tight text-lg">GigBuddy</span>
              ...
              <p className="text-[10px] text-zinc-500 font-sans tracking-wide">Musician Marketplace & MoA Escrow</p>
            </div>
          </div>

          {/* Escrow Status & Platform Meta */}
